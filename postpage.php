...
$cid=$_POST['id'];
$sql = "SELECT DISTINCT RestaurantName, e.Employee_FirstName FROM Restaurant r JOIN Employee e ON r.Restaurant_ID=e.Restaurant_ID where r.Restaurant_ID=" .$cid;
