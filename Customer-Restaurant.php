...
$sql = "SELECT DISTINCT RestaurantName, Employee_FirstName FROM Restaurant";
...
<?php
    $section_sql = "select c.Employee_FirstName from Employee e join Restaurant r on e.Restaurant_ID = r.Restaurant_ID=" . $row["Restaurant_ID"];
